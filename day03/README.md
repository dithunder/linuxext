...
```
Открываем конфигурационный файл grub.cfg и меняем **rd.lvm.lv=v_root/l_root** на **rd.lvm.lv=centos_otus-dnik01/root**. Проверим файл fstab. 
```bash 
...
#
/dev/mapper/centos_otus--dnik01-root / xfs     defaults 0 0
UUID=049f2be2-5dc9-4983-bf92-4592430245e1 /boot xfs     defaults 0 0
/dev/mapper/centos_otus--dnik01-swap /swap swap    defaults 0 0
#VAGRANT-BEGIN
...
```
Правим файл **fstab** для правильного монтирования раздела /home при следующей загрузке. Проверяем файл.
```bash
...
# See man pages fstab(5), findfs(8), mount(8) and/or blkid(8) for more info
#
/dev/mapper/centos_otus--dnik01-root / defaults 0 0
UUID=049f2be2-5dc9-4983-bf92-4592430245e1 /boot     defaults 0 0
/dev/mapper/centos_otus--dnik01-swap /swap    defaults 0 0
#VAGRANT-BEGIN
# The contents below are automatically generated by Vagrant. Do not modify.
#VAGRANT-END
UUID="441485bf-1287-4129-b248-28938c774697" /var ext4 defaults 0 0
